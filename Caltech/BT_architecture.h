...
#define NofTree_second 512
#define NofTree_third 1024
#define NofTree_fourth 2048
#define NofTree_fifth 4096
...
#define tau_selection 30

#define ACF 0
#define CHECKBOARD 1

#define block_size 12
#define block_stride 6
#define cell_size 6
#define padding 0
...
#define additional_negative 10000
#define reasonable_height 50
#define scale_per_octave 7
//#define up_scale_thr log((float)patch_row / (float)reasonable_height) / log((float)1 / (float)pyramid_scale)	//need to be test
#define up_scale_thr 9
#define down_scale_thr 10
#define pyramid_scale pow(0.5, 1 / (double)(scale_per_octave + 1))
#define IoUthr 0.5
#define hard_negative_thr 0.1
#define partial_occ 0.35
#define NEGATIVE_PER_IMAGE 25
...
#define positive_train_dir "D:\\Study/Data/Caltech_Pedestrian/data-USA/training_images/pos/"
#define negative_train_dir "D:\\Study/Data/Caltech_Pedestrian/data-USA/training_images/neg/"
#define hard_negative_dir "D:\\Study/Data/Caltech_Pedestrian/data-USA/images/"
#define save_dir "D:\\Study/Data/Caltech_Pedestrian/data-USA/result/"
#define test_dir "D:\\Study/Data/Caltech_Pedestrian/data-USA/images/"
#define result_dir "D:\\Study/Data/Caltech_Pedestrian/data-USA/result/"
#define ground_truth_dir "D:\\Study/Data/Caltech_Pedestrian/data-USA/annotations/"
#define set05_num 7
#define set06_num 8
...
void split_node(node* tree_ptr, int depth, vector<Mat> filter_list, vector<feature*> positive_original, vector<feature*> negative_original)
{
	...
	else
	{
		...
		for (int fid = 0; fid < positive_original[0]->extracted_feature.size(); fid++)
		{
			...
			//selecting tau
			for (int tau_iter = 0; tau_iter < tau_selection; tau_iter++)
			{
